...
function Spawn_enemies () {
    for (let index = 0; index < 5; index++) {
        Enemy_1 = sprites.create(img`
            ...
            . . . f f f f f f f . . . . . . 
            `, SpriteKind.Enemy)
        tiles.placeOnRandomTile(Enemy_1, sprites.dungeon.floorDark1)
        Enemy_1.follow(Player_1, 20)
    }
    Enemy_1 = sprites.create(img`
        ........................
        ........................
        ...
        ........................
        `, SpriteKind.Enemy)
    tiles.placeOnRandomTile(Enemy_1, sprites.dungeon.doorOpenWest)
    Enemy_1.follow(Player_1, 20)
    Enemy_1 = sprites.create(img`
        ........................
        ........................
        ...
        ........................
        `, SpriteKind.Enemy)
    tiles.placeOnRandomTile(Enemy_1, sprites.dungeon.doorOpenNorth)
    Enemy_1.follow(Player_1, 20)
    Enemy_1 = sprites.create(img`
        ........................
        ........................
        ...
        ........................
        `, SpriteKind.Enemy)
    tiles.placeOnRandomTile(Enemy_1, sprites.dungeon.doorOpenEast)
    Enemy_1.follow(Player_1, 20)
    Enemy_1 = sprites.create(img`
        ........................
        ........................
        ...
        ........................
        `, SpriteKind.Enemy)
    tiles.placeOnRandomTile(Enemy_1, sprites.dungeon.doorOpenSouth)
    Enemy_1.follow(Player_1, 20)
}
